...
const createClusterInjectable = getInjectable({
  ...
  instantiate: (di) => {
    const dependencies: ClusterDependencies = {
      ...
      createCanI: () => { throw new Error("Tried to access back-end feature in front-end."); },
      createAuthorizationApi: () => { throw new Error("Tried to access back-end feature in front-end."); },
      createRequestNamespaceListPermissions: () => { throw new Error("Tried to access back-end feature in front-end."); },
      createCoreApi: () => { throw new Error("Tried to access back-end feature in front-end."); },
